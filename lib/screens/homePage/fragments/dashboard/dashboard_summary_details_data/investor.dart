import 'package:flutter_github_cicd/screens/homePage/fragments/dashboard/dashboard_summary_data/investment_type.dart';
import 'package:flutter_github_cicd/screens/homePage/fragments/dashboard/dashboard_summary_data/portfolio.dart';
  ...
  Investor.fromJson(dynamic json) {
    ...
    investmentType =
        json['investment_type'] != null
            ? InvestmentType.fromJson(json['investment_type'])
            : null;
    portfolio =
        json['portfolio'] != null
