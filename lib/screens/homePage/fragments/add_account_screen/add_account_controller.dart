...
class AddAccountController extends GetxController {
  ...
  AddAccountController(this.dataProvider);
  ...
  var boCodeController = TextEditingController();
  ...
  @override
  void onInit() {
    // emailController.text='mamunur1430@gmail.com';
    // mobileNoController.text='01683769592';
    // boCodeController.text='B0444';
    // otpController.text='111111';
    super.onInit();
  }

  void nextStep() async {
    String url = "/api/add-account/1";
    ...
    if (currentStep.value == 1) {
      mapData['otp_code'] = otpController.text;
      url = "/api/add-account/2";
    }
